...
medical devices such as body wireless sensor networks that are used either to provide body posture correction/monitoring 
or tracking daily activities. In many cases, body wireless sensor networks that are used to track an individual's 
...
The uF!T framework acts as a motivational tool that provides convenient exercise tracking on-the-go. By taking 
out the need to have a gym or time alloted for exercising an individual would be able to take advantage of 
small pockets of time to exercise. Therefore, uF!T intends to assist an individual with a busy lifestyle maintain a healthy lifestyle.
...
Now the solution to our predicament is to try using a combination of the
