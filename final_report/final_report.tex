...
147 million dollars a year \cite{jeffords:obesity}. In addition to the lack of control over how 
well a patient follows drug regiments, doctors cannot guarantee that their patients maintain a 
regular exercise schedule. In a case study involving 20 patients, on the first day all patients agreed
that they would maintain their regiment, but after three months, only
...
Following what is described in the article by \cite{plante:exercisewithanother} having an exercise partner
 ...
 believe that uF!t has thepossibility to solve two problems: \textit{no exercise partner} 
...
Our system consists of an program that counts situps. Once uF!T has detected that 
a user has completed a situp it will communicates to a base 
station wirelessly with a message describing how many situps have been complete.
The following sections describe these componenets.
