...
the US population is mainly a consequence of technology
...
would introduce cascading errors for our system when we attempt to distinguish a situp from other exercises. We chose to test Proper Sensor Placement in order to determine in what ways the mote would be adversely affected by the  sensor shifting. By placing uFit in "shifted" areas, we would simulate real-world scenarios in which the data may suffer from additional unwanted 
noise.
...
is important that we are able to detect the correct amount of 
...
the accuracy of each set of situps involved comparing 
...
lack of battery life discussion because it is important to consider for a device
...
dynamic exercise classification. Each user would possess his/her own
