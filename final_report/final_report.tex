...
will require the evaluation of two things: Data Validation
and Proper Sensor Placement.  Data Validation measures how
accurately we have measured a given position. It is a test to 
see whether or not that our system counts the correct amount 
of reps that were completed in a single trial.  Without good
recognition of exercises, we are unable to trust our system.
...
places: {\secit the arm, center of chest, and the side 
of the chest.} Looking at the graphs depicted in Fig 5,
the results of
