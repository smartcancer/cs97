...
developers have sought to provide creative solutions that complement 
...
Researchers claim that the general decrease in exercise in the US population is is mainly a consequence of technology replacing usual forms of exercising. At one point traveling certain distances involved walking or riding a bicycle, whereas now such distances are covered by either driving or use of public transportation (which generally involve an individual to be sitting). As you can see in Figure 1, most of the reasons can be attributed to issues of convenience and the lack of a support from a workout partner or support group. We believe that the uF!t systems would address these reasons.  
\begin{figure}
\centering
\includegraphics[width=2.0in,width=2in]{./figs/exercise.png}
\caption{Reasons why people dont exercise.}
\end{figure}
...
Therefore, by counting the number of peaks that occur in during the 
exercise, would be able to achieve an accurate account of the number 
of repetitions that were completed.
